     ...
     \textup{expornet}(0.70_{10}) - \textup{expornet}(0.40_{10}) &= 4 \\
                       ...
                       \textup{fraction}(0.04_{10}) >> 4         &= 0.000101000111101011100001010 ~_{~}\times 2^{-1} \qquad(2) \\
                                                         F1 + F2 &= 1.011110101110000101000111010 ~_{~}\times 2^{-1} \\
                                                                 ...
                                                                 &= .\overset{-1 }{1} ~ \overset{-2 }{0} ~ \overset{-3 }{1} ~ \overset{-4 }{1} ~ \overset{-5 }{1} ~ 
                                                                     \overset{-6 }{1} ~ \overset{-8 }{0} ~ \overset{-9 }{1} ~ \overset{-10}{0} ~ \overset{-11}{1} ~ 
                                                                     \overset{-12}{1} ~ \overset{-13}{1} ~ \overset{-14}{0} ~ \overset{-15}{0} ~ \overset{-16}{0} ~ 
                                                                     \overset{-17}{0} ~ \overset{-18}{1} ~ \overset{-19}{0} ~ \overset{-20}{1} ~ \overset{-21}{0} ~ 
                                                                     \overset{-22}{0} ~ \overset{-23}{1} \\
